...
class CDMProcessingVariables:
    ...
    fname_anchor_dates_reid: str = (
        "epic_ddp_concat/cbioportal/timeline_anchor_dates.tsv"
    )
    ...
    fname_comorbidities: str = (
        "epic_ddp_concat/comorbidities/t09_epic_ddp_comorbidities.tsv"
    )
    ...
    fname_dx_timeline_prim: str = (
        "epic_ddp_concat/diagnosis/table_dx_timeline_primary.tsv"
    )
    ...
    fname_darwin_path_molecular: str = (
        "epic_ddp_concat/pathology/table_pathology_molecular_notes_parsed.tsv"
    )
    fname_darwin_path_surgical: str = (
        "epic_ddp_concat/pathology/table_pathology_surgical_notes_parsed.tsv"
    )
    fname_darwin_path_cyto: str = (
        "epic_ddp_concat/pathology/table_pathology_cyto_notes_parsed.tsv"
    )
    fname_darwin_path_heme: str = (
        "epic_ddp_concat/pathology/table_pathology_heme_notes_parsed.tsv"
    )

    ### Specimen submitted
    fname_darwin_path_col_spec_sub: str = (
        "epic_ddp_concat/pathology/table_pathology_col_spec_sub.tsv"
    )
    fname_darwin_path_molecular_note_spec_sub: str = (
        "epic_ddp_concat/pathology/table_pathology_molecular_note_spec_sub.tsv"
    )
    fname_darwin_path_surgical_note_spec_sub: str = (
        "epic_ddp_concat/pathology/table_pathology_surgical_note_spec_sub.tsv"
    )

    fname_darwin_path_dmp: str = (
        "epic_ddp_concat/pathology/table_pathology_impact_dmp_extraction.tsv"
    )
    fname_darwin_path_clean_parsed: str = (
        "epic_ddp_concat/pathology/table_pathology_surgical_samples_parsed.tsv"  # Filename of processed pathology table (variable: fname_darwin_path)
    )
    fname_darwin_path_clean_parsed_specimen: str = (
        "epic_ddp_concat/pathology/table_pathology_surgical_samples_parsed_specimen.tsv"  # Filename of parsed specimen pathology
    )
    fname_darwin_path_clean_parsed_specimen_impact_only: str = (
        "epic_ddp_concat/pathology/table_pathology_impact_only_parsed_specimen.tsv"
    )
    ...
    fname_combine_dop_accession: str = (
        "epic_ddp_concat/pathology/pathology_dop_impact_summary.tsv"
    )
    ...
    ### Timeline
    fname_path_sequencing_cbio_timeline: str = (
        "epic_ddp_concat/pathology/table_timeline_sequencing.tsv"
    )
    ...
    fname_path_pdl1_cbio_timeline: str = (
        "epic_ddp_concat/pathology/table_timeline_pdl1_calls.tsv"
    )
    ...
    fname_path_pdl1_summary_patient: str = (
        "epic_ddp_concat/pathology/table_summary_pdl1_patient.tsv"
    )
    fname_path_pdl1_summary_sample: str = (
        "epic_ddp_concat/pathology/table_summary_pdl1_sample.tsv"
    )
    ...
    fname_radiology_bkup: str = (
        "epic_ddp_concat/radiology/radiology_report_segmentation/impact/intermediate_files_for_qc/ddp_radiology_reports_bkup.tsv"
    )
    fname_radiology_update: str = (
        "epic_ddp_concat/radiology/radiology_report_segmentation/impact/intermediate_files_for_qc/ddp_radiology_reports_update.tsv"
    )
    fname_radiology_to_segment: str = (
        "epic_ddp_concat/radiology/radiology_report_segmentation/impact/intermediate_files_for_qc/ddp_radiology_reports_for_segmentation.tsv"
    )
    fname_radiology_metadata: str = (
        "epic_ddp_concat/radiology/radiology_report_segmentation/impact/intermediate_files_for_qc/radiology_clean_annotations.tsv"
    )
    fname_radiology_impression: str = (
        "epic_ddp_concat/radiology/radiology_report_segmentation/impact/intermediate_files_for_qc/radiology_parse_impression.tsv"
    )
    fname_radiology_findings: str = (
        "epic_ddp_concat/radiology/radiology_report_segmentation/impact/intermediate_files_for_qc/radiology_parse_findings.tsv"
    )
    fname_radiology_findings_long: str = (
        "epic_ddp_concat/radiology/radiology_report_segmentation/impact/intermediate_files_for_qc/radiology_parse_findings_long.tsv"
    )
    ...
    fname_radiology_full_parsed: str = (
        "epic_ddp_concat/radiology/radiology_report_segmentation/impact/ddp_radiology_reports_full_parsed.tsv"
    )

    ## Tumor sites (ClinicalBERT-based method)
    fname_rad_prediction_all_accessions: str = (
        "epic_ddp_concat/radiology/tumor_sites/impact/intermediate_files/radiology_accessions_for_pred_all.tsv"
    )
    ...
    fname_radiology_tumor_site_pred_summary: str = (
        "epic_ddp_concat/radiology/tumor_sites/impact/radiology_tumor_site_predictions_full_summary.tsv"
    )
    fname_rad_tumor_prediction_update: str = (
        "epic_ddp_concat/radiology/tumor_sites/impact/intermediate_files/radiology_tumor_site_predictions_updated.tsv"
    )
    fname_radiology_tumor_site_pred_combined: str = (
        "epic_ddp_concat/radiology/tumor_sites/impact/intermediate_files/radiology_tumor_site_predictions_combined.tsv"
    )
    fname_rad_rpts_for_prediction_tumor_sites: str = (
        "epic_ddp_concat/radiology/tumor_sites/impact/intermediate_files/ddp_radiology_reports_for_prediction.tsv"
    )
    ...
    fname_progression_prediction_all_accessions: str = (
        "epic_ddp_concat/radiology/progression/impact/intermediate_files/radiology_accessions_for_pred_all.tsv"
    )
    fname_radiology_progression_pred_bkup: str = (
        "epic_ddp_concat/radiology/progression/impact/intermediate_files/radiology_cancer_progression_predictions.tsv.bkup"
    )
    ...
    fname_rad_prog_prediction_update: str = (
        "epic_ddp_concat/radiology/progression/impact/intermediate_files/radiology_progression_predictions_updated.tsv"
    )
    fname_rad_prog_prediction_combined: str = (
        "epic_ddp_concat/radiology/progression/impact/intermediate_files/radiology_cancer_progression_predictions_combined.tsv"
    )
    fname_rad_rpts_for_prediction_progression: str = (
        "epic_ddp_concat/radiology/progression/impact/intermediate_files/ddp_radiology_reports_for_prediction_progression.tsv"
    )
    ...
    fname_meds_intervals: str = (
        "epic_ddp_concat/medications/table_medication_intervals.tsv"
    )
    fname_meds_regimens: str = (
        "epic_ddp_concat/medications/table_medication_regimens.tsv"
    )
    ...
    fname_timeline_meds: str = (
        "epic_ddp_concat/medications/table_timeline_medications.tsv"
    )

    fname_tx_summary_patient: str = (
        "epic_ddp_concat/medications/table_tx_summary_patient.tsv"
    )
    fname_tx_summary_sample: str = (
        "epic_ddp_concat/medications/table_tx_summary_sample.tsv"
    )
    ...
    fname_prior_meds_predictions_prefix: str = (
        "epic_ddp_concat/medications/prior_tx_inferences/prior_tx_inferences_impact"
    )
    fname_prior_meds_predictions_comb: str = (
        "epic_ddp_concat/medications/prior_tx_inferences/prior_tx_inferences_impact_combined.tsv"
    )
    fname_prior_meds_predictions_comb_bkup: str = (
        "epic_ddp_concat/medications/prior_tx_inferences/prior_tx_inferences_impact_combined.tsv.bkup"
    )
    fname_prior_meds_predictions_timeline: str = (
        "epic_ddp_concat/medications/prior_tx_inferences/prior_tx_inferences_impact_cbio_timeline.tsv"
    )

    ##############################################################################
    # SDoH derived files
    ##############################################################################
    fname_comorbidities_index: str = (
        "epic_ddp_concat/comorbidities/epic_ddp_comorbidities_index_summary.tsv"
    )
