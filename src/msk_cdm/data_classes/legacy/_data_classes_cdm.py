...
class CDMProcessingVariables:
    ...
    root_path_diagnosis: str = os.path.join(root_path, 'diagnosis_event_abstraction_icd')
    ...
    # Utilities
    ##############################################################################
    script_redcap_pull: str = os.path.join(root_path_cdm_utils, 'redcap/redcap_api_report_pull.py ')
    
    minio_env: str = os.path.join(root_path_cdm_utils, 'minio_env.txt')
    venv: str = '/mind_data/cdm_repos/env_cdm/bin/python '
    
    xmap_met_sites_icd: str = os.path.join(root_path_cdm_utils, 'organ_site_mappings/xwalk_met_site_to_billing_codes.csv')
    xmap_met_sites_impact: str = os.path.join(root_path_cdm_utils, 'organ_site_mappings/xwalk_met_site_to_impact_site_name.csv')
    ...
    script_cbio_ids: str = os.path.join(root_path_cdm_utils, 'cbioportal/cbioportal_api_pull_ids.py ')
    script_cbio_summary: str = os.path.join(root_path_diagnosis, 'processing/run_sample_summary.py')
    ...
    sql_pathology_accessions: str = os.path.join(root_path_sql, 'pathology_report_accessions.sql')
    sql_radiology: str = os.path.join(root_path_sql, 'radiology_report.sql')
    sql_radiology_accessions: str = os.path.join(root_path_sql, 'radiology_report_accessions.sql')
    ...
    sql_clindoc_fu_initial: str = os.path.join(root_path_sql, 'clindoc_initial_and_fu_notes.sql')
    sql_comorbidities: str = os.path.join(root_path_sql, 'comorbidities/comorbidities.sql')
    ...
    sql_labs_antigen: str = os.path.join(root_path_sql, 'labs/cancer_antigen_lab_results.sql')
    ...
    ##############################################################################    
    script_clean_dx: str = os.path.join(root_path_diagnosis, 'processing/darwin_diagnosis.py')
    script_dx_summary: str = os.path.join(root_path_diagnosis, 'processing/darwin_summary_diagnosis.py')
    # script_met_summary: str = os.path.join(root_path_diagnosis, 'processing/run_metastatic_events.py')
    script_dx_timeline: str = os.path.join(root_path_diagnosis, 'processing/dx_timeline.py')
    script_met_site_summary: str = os.path.join(root_path_diagnosis, 'processing/metastatic_site_summary.py')
    ...
    fname_dx_summary: str = 'diagnosis/table_dx_impact_summary.tsv'          # Table of impact sample processed 
    ...
    fname_path_summary: str = 'pathology/table_pathology_impact_sample_summary_dop_anno.tsv'
    
    ##############################################################################
    # PATHOLOGY REPORT derived files
    ##############################################################################    
    script_clean_path: str = os.path.join(root_path_pathology, 'darwin_pathology.py')
    script_path_id_mapping: str = os.path.join(root_path_pathology, 'annotations/pathology_id_mapping.py')
    script_seg_path_surg: str = os.path.join(root_path_pathology, 'segmentation/pathology_parse_surgical.py')
    script_seg_path_mole: str = os.path.join(root_path_pathology, 'segmentation/pathology_parse_molecular.py')
    script_seg_path_heme: str = os.path.join(root_path_pathology, 'segmentation/pathology_parse_heme.py')
    script_pathology_heme_sections: str = os.path.join(root_path_pathology, 'annotations/pathology_parse_heme_section_bm_biopsy.py')
    script_pathology_heme_sections_periph_blood: str = os.path.join(root_path_pathology, 'annotations/pathology_parse_heme_section_periph_blood.py')
    script_seg_path_spec_sub: str = os.path.join(root_path_pathology, 'segmentation/pathology_parse_specimen_submitted.py')
    script_seg_path_surg_spec: str = os.path.join(root_path_pathology, 'segmentation/pathology_parsing_surgical_specimens.py') 
    script_path_accessions: str = os.path.join(root_path_pathology, 'annotations/pathology_extract_accession.py')
    script_path_dop: str = os.path.join(root_path_pathology, 'annotations/pathology_extract_dop.py')   
    script_path_synoptic: str = os.path.join(root_path_pathology, 'annotations/pathology_synoptic_logistic_model.py')
    script_combine_accession_dop: str = os.path.join(root_path_pathology, 'annotations/pathology_extract_dop_impact_wrapper.py')
    script_pathology_summary: str = os.path.join(root_path_pathology, 'annotations/pathology_impact_summary_dop_annotator.py')
    script_pathology_pdl1: str = os.path.join(root_path_pathology, 'annotations/pathology_extract_pdl1.py')
    script_pathology_gleason: str = os.path.join(root_path_pathology, 'annotations/pathology_extract_gleason.py')
    script_pathology_mmr: str = os.path.join(root_path_pathology, 'annotations/pathology_extract_mmr.py')
    
    ## cBioPortal file generation scripts
    ### Timeline scripts
    script_pathology_sequencing_timeline: str = os.path.join(root_path_pathology, 'pipeline/cbio_timeline_sequencing.py')
    script_pathology_specimen_timeline: str = os.path.join(root_path_pathology, 'pipeline/cbio_timeline_specimen.py')
    script_pathology_pdl1_timeline: str = os.path.join(root_path_pathology, 'pipeline/cbio_timeline_pdl1.py')
    script_pathology_gleason_timeline: str = os.path.join(root_path_pathology, 'pipeline/cbio_timeline_gleason.py')
    ...
    script_pathology_gleason_summary: str = os.path.join(root_path_pathology, 'pipeline/cbio_gleason_summary.py')
    
    # Pathology Segmentation tasks
    ### Pathology table from copath
    fname_path_synoptic_labels: str = 'pathology/table_pathology_surgical_synoptic_labels.csv'
    fname_path_synoptic: str = 'pathology/path_synoptic_predictions.tsv'
    
    ### IDB table    
    fname_pathology: str = 'pathology/ddp_pathology_reports.tsv'
    fname_pathology_update: str = 'pathology/intermediate_files/ddp_pathology_reports_update.tsv'
    fname_pathology_bkup: str = 'pathology/intermediate_files/ddp_pathology_reports_bkup.tsv'
    ...
    fname_darwin_path_molecular: str = 'pathology/table_pathology_molecular_notes_parsed.tsv'
    fname_darwin_path_surgical: str = 'pathology/table_pathology_surgical_notes_parsed.tsv'
    ...
    fname_darwin_path_molecular_note_spec_sub: str = 'pathology/table_pathology_molecular_note_spec_sub.tsv'
    fname_darwin_path_surgical_note_spec_sub: str = 'pathology/table_pathology_surgical_note_spec_sub.tsv'
    ...
    fname_darwin_path_clean_parsed_specimen_impact_only: str = 'pathology/table_pathology_impact_only_parsed_specimen.tsv'
    ...
    fname_darwin_path_heme_parse_bm_biopsy: str = 'pathology/pathology_heme_bm_biopsy.tsv'
    fname_darwin_path_heme_parse_periph_blood: str = 'pathology/pathology_heme_periph_blood.tsv'
    ...
    fname_path_specimen_surgery_cbio_timeline: str = 'pathology/table_timeline_specimen_surgery.tsv'
    fname_path_gleason_cbio_timeline: str = 'pathology/table_timeline_gleason_scores.tsv'
    fname_path_pdl1_cbio_timeline: str = 'pathology/table_timeline_pdl1_calls.tsv'
    fname_path_gleason_summary_patient: str = 'pathology/table_summary_gleason_patient.tsv'
    fname_path_gleason_summary_sample: str = 'pathology/table_summary_gleason_sample.tsv'
    ...
    script_radiology_etl: str = os.path.join(root_path_radiology, 'segmentation/run_radiology_segmentation.py ')
    script_radiology_features: str = os.path.join(root_path_pathology, '/features/run_feature_extraction.py ')
    
    ## Tumor site prediction scripts
    script_tumor_site_prediction_build: str = os.path.join(root_path_radiology, 'pipeline/predictions/radiology_tumor_site_pred.py ')
    script_bash_predict_tumor_site: str = os.path.join(root_path_radiology, 'condor/run_infer_met_sites.sh ')
    script_tumor_site_prediction_merge: str = os.path.join(root_path_radiology, 'pipeline/predictions/combine_results.py ')
    script_tumor_site_prediction_add_metadata: str = os.path.join(root_path_radiology, 'pipeline/predictions/add_metadata.py ')
    script_tumor_site_prediction_cbio_timeline: str = os.path.join(root_path_radiology, 'pipeline/timeline_cbio_tumor_sites.py ')
    script_tumor_site_prediction_cbio_summary: str = os.path.join(root_path_radiology, 'pipeline/tumor_site_prediction_summary.py ')
    
    
    ## Progression prediction scripts
    script_progression_prediction_build: str = os.path.join(root_path_progression, 'pipeline/predictions/cmd_line_radiology_progression_pred.py ')
    script_progression_prediction_merge: str = os.path.join(root_path_progression, 'pipeline/predictions/combine_results.py ')
    script_progression_prediction_add_metadata: str = os.path.join(root_path_progression, 'pipeline/predictions/add_metadata.py ')
    script_bash_predict_progression: str = os.path.join(root_path_progression, 'condor/cmd_run_condor_infer.sh ')

    # Radiology Filenames, raw and segmentations
    fname_radiology: str = '/radiology/radiology_report_segmentation/impact/ddp_radiology_reports.tsv'
    ...
    fname_rad_embedding: str = '/mind_data/fongc2/radiology_met_prediction/assets/clinicalbert_w2v.txt'

    ## Word embeddings method
    fname_rad_met_feature_impressions: str = '/radiology/radiology_features_embedding_avg_impressions.csv'
    fname_rad_met_feature_findings_parsed: str = '/radiology/radiology_features_embedding_avg_findings_parsed.csv'
    fname_rad_met_feature_findings_all: str = '/radiology/radiology_features_embedding_avg_findings_all.csv'
    ...
    fname_radiology_tumor_site_pred: str = '/radiology/tumor_sites/impact/radiology_tumor_site_predictions_full.tsv'
    ...
    log_fname_template_tumor_sites: str = '/mind_data/cdm_repos/radiology_met_prediction/condor/logs/log_infer.txt'
    fname_tumor_sites_timeline_cbio: str = '/radiology/tumor_sites/impact/table_timeline_tumor_sites.tsv'
    ...
    fname_radiology_progression_pred: str = '/radiology/progression/impact/radiology_cancer_progression_predictions.tsv'
    ...
    log_fname_template_progression: str = '/mind_data/cdm_repos/progression-predict/condor/logs/log_infer.txt'
    ...
    ##############################################################################    
    script_meds_clean: str = os.path.join(root_path_treatments, 'processing/medications_table_cleaning.py')
    script_meds_to_regimens: str = os.path.join(root_path_treatments, 'processing/run_chemo_to_regimens.py')
    script_meds_timeline: str = os.path.join(root_path_treatments, 'processing/medications_timeline.py')
    script_surgery_timeline: str = os.path.join(root_path_treatments, 'processing/surgery_timeline.py')
    script_radiation_timeline: str = os.path.join(root_path_treatments, 'processing/radiation_timeline.py')
    ...
    ############################################################################## 
    script_prior_meds_timeline: str = os.path.join(root_path_prior_meds, 'pipeline/prior_medications_timeline.py')
    script_prior_meds_fix_output: str = os.path.join(root_path_prior_meds, 'pipeline/fix_prior_meds.py')
    ...
    # SDoH derived files
    ##############################################################################
    script_comorbidities_index: str = os.path.join(root_path_disparities, 'processing/process_cci.py')
    fname_comorbidities_index: str = 'comorbidities/ddp_comorbidities_index_summary.tsv'
    
    script_smoking_status: str = os.path.join(root_path_disparities, 'processing/process_smoking_history.py')
    ...
    script_insurance: str = os.path.join(root_path_disparities, 'processing/process_insurance.py')
...
class CDMProcessingVariablesCbioportal:
    ...
    script_cbio_timeline_deid_files: str = os.path.join(root_path_cbio_etl, 'timeline/cbioportal_timeline_deid_files.py')
    script_cbio_timeline_seq_spec: str = os.path.join(root_path_cbio_etl, 'timeline/cbioportal_timeline_specimen.py')
    ...
    script_cbio_timeline_disease_status: str = os.path.join(root_path_cbio_etl, 'timeline/disease_status_cbioportal_timeline.py')
    ...
    script_timeline_follow_up: str = os.path.join(root_path_cbio_etl, 'timeline/cbioportal_timeline_follow_up.py')
    script_summary_overall_survival: str = os.path.join(root_path_cbio_etl, 'summary/cbioportal_overall_survival.py')
    
    script_create_summary_templates: str = os.path.join(root_path_cbio_etl, 'summary/cbioportal_template_generator.py ')
    script_summary_formatting: str = os.path.join(root_path_cbio_etl, 'summary/wrapper_cbioportal_summary_creator.py')
    script_copy_to_minio: str = os.path.join(root_path_cbio_etl, 'utils/wrapper_cbioportal_copy_to_minio.py')   
    script_copy_to_cdsi_repo: str = os.path.join(root_path_cbio_etl, 'utils/copy_cbio_files_to_automation_folder.py')   
    
    script_cbio_etl_git_fetch: str = os.path.join(root_path_cbio_etl, 'git-tasks/git_fetch.sh ')
    script_cbio_etl_git_fetch_cdsi_copy: str = os.path.join(root_path_cbio_etl, 'git-tasks/git_fetch_impact_pipeline.sh ')
    script_cbio_etl_git_push: str = os.path.join(root_path_cbio_etl, 'git-tasks/git_push.sh ')
    script_cbio_etl_git_push_cdsi_copy: str = os.path.join(root_path_cbio_etl, 'git-tasks/git_push_impact_pipeline.sh ')
    script_cbio_etl_git_fetch_impact: str = os.path.join(root_path_cbio_etl, 'git-tasks/git_fetch_impact_ids.sh ')
    ...
    fname_cbio_header_template_p: str = 'cbioportal/cbioportal_summary_header_patient.tsv'
    fname_cbio_header_template_s: str = 'cbioportal/cbioportal_summary_header_sample.tsv'
    fname_p_sum_template_cdsi: str = 'cbioportal/intermediate_files/data_clinical_patient_template_cdsi.txt'
    fname_s_sum_template_cdsi: str = 'cbioportal/intermediate_files/data_clinical_sample_template_cdsi.txt'
